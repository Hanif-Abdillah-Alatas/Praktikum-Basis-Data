...
--
-- Host: 127.0.0.1
-- Generation Time: May 21, 2025 at 06:03 AM
...
ALTER TABLE `produk`
  ...
  ADD UNIQUE KEY `index_kode_produk` (`kode_produk`),
  ADD KEY `index_harga` (`harga`);
...
ALTER TABLE `transaksi`
  ...
  ADD KEY `index_total_harga` (`total_harga`),
